    ...
    variants: {
      variant: {
        default:
          ...
          "bg-gradient-to-b from-purple-600 to-indigo-600 text-primary-foreground hover:from-purple-500 hover:to-indigo-500",
          destructive:
        ...
        muted: "bg-neutral-100 text-neutral-500 hover:bg-neutral-200",
        teritary: "bg-blue-100 text-blue-600 border-transparent hover:bg-blue-200",
      },
      size: {
